...
//import li.tmj.ui.fx.controls.FxControlable;
...
//
//				} catch (KeyException e) { // key also not found in this fallback config.
//					// try next
...
//			}
//		}
//		Logger.warn("Key \"{}\" not found in configuration \"{}\"",key,name);
...
//			Logger.error("Configuration \"{}\" has no default!",name);
//			throw new NoSuchElementException("Configuration \"" + name + "\"has no default!");
//		}
